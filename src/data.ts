...
export const data: Data = {
  activities: [
    ...
    },
    {
      ...
      booking_required: true,
      max_group_size: null,
      physical_intensity: { min: 2, max: 4 },
      prerequisites: [],
      host: {
        name: 'Wushu London',
      },
    ...
    },
    {
      ...
      max_group_size: null,
      physical_intensity: { min: 1, max: 1 },
      prerequisites: [],
      host: {
    ...
    },
    {
      ...
      booking_required: true,
      max_group_size: null,
      physical_intensity: { min: 2, max: 5 },
      prerequisites: [],
      host: {
        name: 'parkrun',
      },
